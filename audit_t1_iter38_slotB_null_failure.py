#!/usr/bin/env python3
"""Audit T1 iter38 slot-B corrected null-gate outcome."""
...
NULL_JSON = RESULTS / "t1_iter38_slotB_nulls_corrected_20260510_145507.json"
OUT_JSON = RESULTS / "t1_iter38_slotB_null_failure_audit_20260510.json"
OUT_MD = RESULTS / "t1_iter38_slotB_null_failure_audit_20260510.md"
...
def main() -> None:
    ...
    report = {
        ...
        "script": "audit_t1_iter38_slotB_null_failure.py",
        "input_artifact": NULL_JSON.relative_to(ROOT).as_posix(),
        "not_a_model_headline": True,
        "supersedes_prior_artifact": "results/t1_iter38_slotB_nulls_20260510_143921.json",
