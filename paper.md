...
- T1 strongest candidate (post-publication replication target): T1 LOOCV CCC = 0.7366 (MAE = 1.731; iter34 hybrid, N = 93). Paired-bootstrap Δ vs iter12-honest on the n = 93 common cohort: +0.0812, frac > 0 = 0.9714, 95% CI [−0.003, +0.166].
- T1 transportability (between-site): T1 LOSO transportability mean CCC = 0.456 (iter34 architecture, two-way mean across NLS → WPD and WPD → NLS).
