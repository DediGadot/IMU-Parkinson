...
def main(null_mode: str = "") -> None:
    ...
    out = {
        "name": "lockbox_t1_S8_item12mfdfa_item13ph_joint",
        "created_at_utc": ts,
    ...
    path = Path(f"results/lockbox_t1_S8_item12mfdfa_item13ph_joint_{ts}{suffix}.json")
    path.write_text(json.dumps(out, indent=2))

    oof_path = Path(f"results/oof_t1_S8_item12mfdfa_item13ph_joint_{ts}{suffix}.npz")
    np.savez(
        oof_path,
        sids=sids,
        y_t1=y_t1,
