...
- Name: `Synthetic ppp_pd_vme value for PI_NAME`
- Institution: `Synthetic ppp_pd_vme value for INSTITUTION`
- Department/lab: `Synthetic ppp_pd_vme value for DEPARTMENT_OR_LAB`
- Email: `synthetic.ppp_pd_vme.pi_email@example.edu`
- Phone: `Synthetic ppp_pd_vme value for PI_PHONE`
- PhD applicant confirmed: `Synthetic ppp_pd_vme value for YES_NO_AND_NAME`
- Short PI CV attached: `Yes, synthetic confirmation`
- Organization class: `Synthetic ppp_pd_vme value for PRE_APPROVED_OR_RDSRC_REVIEW_REQUIRED`

Governance status:

- IRB / ethics approval, non-WMO declaration, or exemption status: `Synthetic ppp_pd_vme value for IRB_OR_ETHICS_STATUS`
- Grant/protocol/patient-letter attachments, if relevant: `Synthetic ppp_pd_vme value for ATTACHMENTS`
- RDSRC deadline and internal pre-check date, if non pre-approved: `Synthetic ppp_pd_vme value for DATES`
- Research Support pre-submission check completed: `Yes, synthetic confirmation`
...
|---|---|---|---|---|
| `Synthetic ppp_pd_vme value for PI_NAME` | `Synthetic ppp_pd_vme value for INSTITUTION` | Principal investigator / PhD applicant or supervisor | `synthetic.ppp_pd_vme.pi_email@example.edu` | Yes |
| `Synthetic ppp_pd_vme value for ANALYST_NAME` | `Synthetic ppp_pd_vme value for INSTITUTION` | Approved analyst | `synthetic.ppp_pd_vme.email@example.edu` | Yes |

Data custodian:

- Name: `Synthetic ppp_pd_vme value for DATA_CUSTODIAN`
- Email: `synthetic.ppp_pd_vme.custodian_email@example.edu`
