...
- Name: `Synthetic ppmi_verily value for PI_NAME`
- Institution: `Synthetic ppmi_verily value for INSTITUTION`
- Department/lab: `Synthetic ppmi_verily value for DEPARTMENT_OR_LAB`
- Email: `synthetic.ppmi_verily.pi_email@example.edu`
- Phone: `Synthetic ppmi_verily value for PI_PHONE`
- Institutional address: `Synthetic ppmi_verily value for ADDRESS`

Ethics / governance status:

- IRB protocol, exemption, or non-human-subjects determination: `Synthetic ppmi_verily value for IRB_ID_OR_STATUS`
- Institutional data-security contact, if required: `Synthetic ppmi_verily value for CONTACT`
- PPMI account username or application ID, if already assigned: `Synthetic ppmi_verily value for PPMI_ID`
...
|---|---|---|---|---|
| `Synthetic ppmi_verily value for PI_NAME` | `Synthetic ppmi_verily value for INSTITUTION` | Principal investigator / data custodian | `synthetic.ppmi_verily.pi_email@example.edu` | Yes |
| `Synthetic ppmi_verily value for ANALYST_NAME` | `Synthetic ppmi_verily value for INSTITUTION` | Approved analyst | `synthetic.ppmi_verily.email@example.edu` | Yes |

Data custodian:

- Name: `Synthetic ppmi_verily value for DATA_CUSTODIAN`
- Email: `synthetic.ppmi_verily.custodian_email@example.edu`
