...
- Name: `Synthetic icicle_gait value for PI_NAME`
- Institution: `Synthetic icicle_gait value for INSTITUTION`
- Department/lab: `Synthetic icicle_gait value for DEPARTMENT_OR_LAB`
- Email: `synthetic.icicle_gait.pi_email@example.edu`
- Phone: `Synthetic icicle_gait value for PI_PHONE`
- Newcastle / ICICLE contact: `Synthetic icicle_gait value for CONTACT`
- IRB / ethics approval or exemption status: `Synthetic icicle_gait value for IRB_OR_ETHICS_STATUS`
- Data custodian: `Synthetic icicle_gait value for DATA_CUSTODIAN`
...
|---|---|---|---|---|
| `Synthetic icicle_gait value for PI_NAME` | `Synthetic icicle_gait value for INSTITUTION` | Principal investigator / data custodian | `synthetic.icicle_gait.pi_email@example.edu` | Yes |
| `Synthetic icicle_gait value for ANALYST_NAME` | `Synthetic icicle_gait value for INSTITUTION` | Approved analyst | `synthetic.icicle_gait.email@example.edu` | Yes |

Data custodian:

- Name: `Synthetic icicle_gait value for DATA_CUSTODIAN`
- Email: `synthetic.icicle_gait.custodian_email@example.edu`
