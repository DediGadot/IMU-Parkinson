...
- Name: `Synthetic hssayeni_mjff value for PI_NAME`
- Synapse username: `Synthetic hssayeni_mjff value for SYNAPSE_USERNAME`
- Institution: `Synthetic hssayeni_mjff value for INSTITUTION`
- Department/lab: `Synthetic hssayeni_mjff value for DEPARTMENT_OR_LAB`
- Email: `synthetic.hssayeni_mjff.pi_email@example.edu`
- Phone: `Synthetic hssayeni_mjff value for PI_PHONE`
- IRB / ethics approval or exemption status: `Synthetic hssayeni_mjff value for IRB_OR_ETHICS_STATUS`
- Data custodian: `Synthetic hssayeni_mjff value for DATA_CUSTODIAN`
...
|---|---|---|---|---|---|
| `Synthetic hssayeni_mjff value for PI_NAME` | `Synthetic hssayeni_mjff value for INSTITUTION` | Principal investigator / data custodian | `Synthetic hssayeni_mjff value for SYNAPSE_USERNAME` | `synthetic.hssayeni_mjff.pi_email@example.edu` | Yes |
| `Synthetic hssayeni_mjff value for ANALYST_NAME` | `Synthetic hssayeni_mjff value for INSTITUTION` | Approved analyst | `Synthetic hssayeni_mjff value for SYNAPSE_USERNAME` | `synthetic.hssayeni_mjff.email@example.edu` | Yes |

Data custodian:

- Name: `Synthetic hssayeni_mjff value for DATA_CUSTODIAN`
- Email: `synthetic.hssayeni_mjff.custodian_email@example.edu`
