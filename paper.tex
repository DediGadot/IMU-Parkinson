...
\title{[STALE -- LEGACY PRE-AUDIT -- DO NOT CITE] Healthy-control-anchored semi-supervised ranking improves calibration of wearable Parkinson's disease motor assessment}
...
This file preserves pre-leakage manuscript archaeology. Current claims live in
\texttt{CLAUDE.md}, \texttt{paper.md}, and \texttt{CURRENT\_PAPER.html}; render
with \texttt{uv run python render\_current\_paper.py}. Current anchors: T1
canonical \texttt{0.6550}, T1 candidate \texttt{0.7366}, T3 \texttt{0.3784},
LOSO \texttt{0.150}. Old SSL/XGBRanker \texttt{0.868} / \texttt{0.776} claims
