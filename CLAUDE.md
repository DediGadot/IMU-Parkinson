...
| **T1 multi-task LGB chain — NEW CANDIDATE 2026-05-05 (F65)** | **`run_t1_iter30b_lockbox.py --mode lockbox --variant V1_random`** — Stage1 Ridge(H&Y + cv_yrs + cv_sex + cv_dbs) + Stage2 sklearn RegressorChain(LGBMRegressor) jointly predicting items 9-14 residuals (train-mean centered); per-fold K=500 LGB-importance selector. Mean of 3 seeds (42, 1337, 7). | **0.7087** (raw +0.054 over 0.6550; bootstrap frac>0=0.872, frac>+0.025=0.730 vs iter12 honest — moderate but BELOW strict 0.95 gate; +0.054 raw matches iter6 step-function band) | 1.933 | `results/preregistration_t1_iter30b_V1_random_20260505_201626.json` (formula_sha256 `512ed04f...`); `results/lockbox_t1_iter30b_V1_random_20260505_211112.json` |
