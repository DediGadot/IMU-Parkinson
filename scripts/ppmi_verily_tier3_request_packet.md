...
- Email: `[PI_EMAIL]`
- Phone: `[PI_PHONE]`
- Institutional address: `[ADDRESS]`

Ethics / governance status:

- IRB protocol, exemption, or non-human-subjects determination: `[IRB_ID_OR_STATUS]`
- Institutional data-security contact, if required: `[CONTACT]`
- PPMI account username or application ID, if already assigned: `[PPMI_ID]`
