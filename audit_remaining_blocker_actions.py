...
RULES: list[dict[str, Any]] = [
    ...
    {
        "id": "conformal_abstention_no_rescue",
        "patterns": [r"conformal/abstention", r"no deployable abstention rescue"],
        "category": "uncertainty_no_rescue",
        "action_type": "paper_uncertainty_only",
        "reason": "Conformal intervals are useful reporting evidence but do not improve deployable T3 CCC.",
        "recommended_next_action": "Report intervals/abstention curves as uncertainty evidence.",
    },
    {
